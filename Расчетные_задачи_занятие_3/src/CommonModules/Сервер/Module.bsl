...
Процедура ЗаполнитьНаборЗаписей_ПлановыеОсновныеНачисления(Источник)
	...
	Если ТипЗнч(Источник) = Тип("ДокументОбъект.ПриказОбУвольнении") Тогда
		...
		|ИЗ
		|	РегистрСведений.ПлановыеОсновныеНачисления.СрезПоследних(&ДатаСобытия, ФизическоеЛицо = &ФизическоеЛицо) КАК ПлановыеОсновныеНачисленияСрезПоследних";
...
Процедура ЗаполнитьНаборЗаписей_ПлановыеДополнительныеНачисления(Источник)
	...
	Если ТипЗнч(Источник) = Тип("ДокументОбъект.ПриказОбУвольнении") Тогда
		...
		|ИЗ
		|	РегистрСведений.ПлановыеДополнительныеНачисления.СрезПоследних КАК ПлановыеДополнительныеНачисленияСрезПоследних";
